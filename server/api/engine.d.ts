...
declare enum GameState {
    START = 0,
    TURN_WAITING = 1,
    RESOLVING_LOGICAL_STACK = 2,
    RESOLVING_REACTION_STACK = 3,
    RESOLVING_EVENT_STACK = 4,
    WAITING_FOR_PLAYER_CHOICE = 5,
    END = 6
}
...
declare class PlayerChoiceStep extends LogicalStep {
    ...
    constructor(playerUUID: LogicalVariable, choiceType: PlayerChoiceType, options: LogicalVariable, preposition: PlayerChoicePreposition, logicalBufferReturnKey: string);
    processAndAdvance(logicalBuffer: LogicalBuffer, gameDTO: GameDTO): boolean;
